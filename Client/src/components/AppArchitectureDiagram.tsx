...
const AppArchitectureDiagram: React.FC<AppArchitectureDiagramProps> = ({
  width = "100%",
  height = "auto"
}) => {
  return (
    <div className="architecture-diagram">
      <svg width={width} height={height} viewBox="0 0 800 600" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Legend */}
        <rect x="50" y="480" width="700" height="90" rx="5" ry="5" fill="#f0f0f0" stroke="#666" strokeWidth="1" />
        <text x="400" y="500" textAnchor="middle" fontSize="14" fontWeight="bold">Superhero Curriculum Architecture</text>
        <text x="400" y="520" textAnchor="middle" fontSize="12">Dyslexia-Friendly Components and Their Relationships</text>
        <text x="400" y="540" textAnchor="middle" fontSize="11" fill="#666">This diagram shows how different parts of the application work together</text>
        <text x="400" y="560" textAnchor="middle" fontSize="11" fill="#666">to create an accessible, engaging learning experience.</text>
      </svg>
    </div>
  );
};
